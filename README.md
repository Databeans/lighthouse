...
- --jars: Path to the clusteringinfo_2.12-0.1.0.jar file.  
...
```  
### Using DATABRICKS  
1. Download the notebook and import it to your workspace. You can download it from [here](https://bitbucket.org/data_beans/lighthouse/src/user-guide/notebooks/databricks/DeltaClusteringMetrics.scala).  
...
- DeltaClusteringMetrics is only compatible with Delta tables and may not work with other table formats.  

## TECHNOLOGIES
___ 
DeltaClusteringMetrics supports:  
- Scala 2.12.13  
- Spark 3.2.0  
- Delta 2.0.0  
